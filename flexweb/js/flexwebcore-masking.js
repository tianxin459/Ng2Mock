/*
Flex Web Core v2.0.3
$Header: //FlexWeb/v2.0.3/dist/js/flexwebcore-masking.js#10 $
$DateTime: 2016/07/22 18:54:17 $
*/
...
$(document).ready(function() {
  ...
  // Auto forwarding to next input id when input mask complete
  function nextFocus($el) {
    var target = $($el).data('next-focus');
    if (target !== undefined) {
      $('#'+target).focus();
    }
  }
  
  function prevFocus($el) {
    var target = $($el).data('prev-focus');
    if (target !== undefined) {
      $('#'+target).focus();
    }
  }
  ...
  //   $('#pan-combo-container').addClass('input--pan-combo--next-page');
  // }
  // 
  // function panPrevPage() {
  //   $('#pan-combo-container').removeClass('input--pan-combo--next-page');
  // }
    
  // Input mask types
  $(".input-mask-pan").inputmask("9999  9999  9999  9999");
  // $(".input-mask-pan-combo").inputmask({ 
  ...
  //   } 
  // });
  $(".input-mask-moneypak").inputmask("999 999 9999 9999");
  $(".input-mask-ssn").inputmask("999-99-9999");
  $(".input-mask-phone").inputmask("(999) 999-9999");
  $(".input-mask-char-two").inputmask("99");
  $(".input-mask-char-three").inputmask("999");
  $(".input-mask-char-four").inputmask("9999");
  $(".input-mask-char-five").inputmask("99999");
  $(".input-mask-char-six").inputmask("999999");
  $(".input-mask-char-eight").inputmask("99999999");
  $(".input-mask-expiration").inputmask("99/99");
  $(".input-mask-dob").inputmask("99/99/9999");
  $(".input-mask-dob-short").inputmask("99/9999");
  // $(".input-mask-expiration-combo").inputmask({ 
  //   mask: "99/99", 
  //   oncomplete: function() {
  //     $('.input__icon-cvv').addClass('input__icon-cvv--on');
  //     nextFocus(this);
  //   },
  //   oncleared: function() {
  //     panPrevPage();
  ...
  //   }
  // });
  // $(".input-mask-cvv-combo").inputmask({
  //   mask: "999",
  //   oncleared: function() {
  //     prevFocus(this);
  //     $('.input__icon-cvv').removeClass('input__icon-cvv--on');
  //   }
  // });
});